...
class Ablation_Prompting:
    ...
    def load_in_ablation_prompts(self, prompts_folder='./manual_prompts_transated', prompts_file='decompositions_only_prompting.txt'):
    ...
    def process_record(self, record, naive_prompts):
        try:
            ...
            result = {
                ...
                'normalized_facts': record['normalized_context']['Fact'],
                'normalized_rules': record['normalized_context']['and_or'],
                'normalized_conjecture': record['normalized_conjecture'],
                'answer': answer,
